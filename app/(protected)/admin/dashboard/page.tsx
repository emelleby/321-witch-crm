                    ...
                    <CardContent>
                        <div className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <div className="h-2 rounded-full bg-muted overflow-hidden">
                                    <div
                                        ...
                                        style={{
                                            width: `${(stats.ticketsByStatus.open / stats.totalTickets) * 100}%`
                                        }}
                                    />
                                </div>
                            </div>
                            <div className="space-y-2">
                                <div className="flex items-center justify-between text-sm">
                                    <span>Pending</span>
                                    <span className="font-medium">{stats.ticketsByStatus.pending}</span>
                                </div>
                                <div className="h-2 rounded-full bg-muted overflow-hidden">
                                    <div
                                        className="h-full bg-yellow-500"
                                        style={{
                                            width: `${(stats.ticketsByStatus.pending / stats.totalTickets) * 100}%`
                                        }}
                                    />
                                </div>
                            </div>
                            <div className="space-y-2">
                                ...
                                <div className="h-2 rounded-full bg-muted overflow-hidden">
                                    <div
                                        ...
                                        style={{
                                            width: `${(stats.ticketsByStatus.closed / stats.totalTickets) * 100}%`
                                        }}
                                    />
                                </div>
                            </div>
