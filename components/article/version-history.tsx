...
import { History, ArrowLeftRight, RotateCcw } from 'lucide-react'
...
export function VersionHistory({
    ...
    const fetchVersions = async () => {
        ...
        try {
            ...
            setVersions(versionsData.map(version => ({
                ...version,
                                                ...
                                                <AlertDialog>
                                                    ...
                                                    <AlertDialogContent>
                                                        <AlertDialogHeader>
                                                            ...
                                                            <AlertDialogDescription>
                                                                This will revert the article to this version.
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="p-2 bg-muted rounded-md max-h-[300px] overflow-y-auto">
                                            {renderDiff(selectedVersion.content, compareVersion.content)}
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <div className="p-2 bg-muted rounded-md">
                                                {renderDiff(selectedVersion.category, compareVersion.category)}
                                            </div>
                                        </div>
